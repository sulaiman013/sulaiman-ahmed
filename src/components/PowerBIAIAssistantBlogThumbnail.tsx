...
export default function PowerBIAIAssistantBlogThumbnail() {
  return (
    <div className="relative w-full aspect-[21/9] rounded-lg overflow-hidden bg-background-elevated border border-border">
      ...
      <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full bg-violet-100 dark:bg-violet-950/40 blur-[80px]" />
      <div className="absolute -bottom-16 -left-16 w-56 h-56 rounded-full bg-violet-100 dark:bg-violet-950/40 blur-[70px]" />
      ...
      <div className="absolute top-3 right-4 z-20 flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-violet-100 dark:bg-violet-950/40 border border-border">
      ...
      <div className="relative z-10 flex items-center justify-between h-full px-7 md:px-10 pt-2">
        ...
        <div className="flex-1 min-w-0 max-w-[58%]">
          <div className="flex items-center gap-2 mb-2.5">
            ...
            <span className="font-mono px-2 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider bg-violet-100 dark:bg-violet-950/40 border border-border text-violet-700 dark:text-violet-300">
              vs Copilot
            </span>
          </div>
          ...
          {/* Inline cost callout */}
          <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-md border border-border bg-violet-100 dark:bg-violet-950/40 w-fit">
            <span className="font-mono text-[10px] uppercase tracking-wider text-foreground-muted font-medium">
              Total cost
            </span>
            <span className="font-mono text-[14px] font-bold text-violet-700 dark:text-violet-300">
              ~$800/yr
            </span>
        ...
        <div className="hidden sm:flex flex-col items-center gap-2 ml-4">
          ...
          <div className="flex flex-col gap-1.5 w-[230px]">
            ...
            <div className="flex items-center justify-between px-2.5 py-2 rounded-md border border-border-strong bg-violet-100 dark:bg-violet-950/40">
              <div className="flex items-center gap-1.5">
                <Zap className="w-3 h-3 text-violet-700 dark:text-violet-300" />
                <span className="text-[10px] font-bold text-violet-700 dark:text-violet-300">
                  Custom Chatbot
                </span>
              </div>
              <span className="font-mono text-[9px] text-violet-700 dark:text-violet-300 font-semibold uppercase tracking-wider">
                Full control
              </span>
            </div>
          </div>
